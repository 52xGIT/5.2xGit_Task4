...
$(document).ready(function () {
  ...
  $(".algo-btn").click(function () {
    ...
    $("#sort-stop").removeClass("display-flex");
    $("#sort-stop").addClass("display-none");
  });
  ...
  $("#stop").click(function () {
    if (!algo_selected || algo_selected == undefined) {
      return;
    }
    sortStop = true;
    $("#sort-stop").removeClass("display-none");
    $("#sort-stop").addClass("display-flex");
  });
